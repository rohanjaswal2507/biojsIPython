...
def install(enable=False, **kwargs):
    """
    Install the biojsWidget nbextension assets
    ...
    **kwargs: keyword arguments
    ...
    directory = join(dirname(abspath(__file__)), 'static', 'biojs')

    kwargs = {k: v for k, v in kwargs.items() if not (v is None)}

    kwargs["destination"] = "biojs"
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Installs biojsWidget nbextension")
